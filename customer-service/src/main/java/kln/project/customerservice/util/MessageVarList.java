package kln.project.customerservice.util;
...
public class MessageVarList {
    ...
    public static final String COMMON_SERVICE_UNAVAILABLE = "Requsted service unavailable.";
    ...
    public static final String CUSTOMER_ID_NULL = "Customer id is null";
    public static final String CUSTOMER_NIC_NULL = "Customer NIC is null";
    public static final String CUSTOMER_NAME_NULL ="Customer name is null" ;
    public static final String CUSTOMER_ADDRESS_NULL = " Customer address is null";
    public static final String CUSTOMER_TELNO_NULL ="Customer tel no is null" ;
    public static final String CUSTOMER_EMAIL_NULL ="Customer email is null" ;
    public static final String CUSTOMER_ASSIGNED_AREA_NULL = "Customer district is null";
}
