...
public class MessageVarList {
    ...
    public static final String ID_NULL = "reg id is null.";
    public static final String WRONG_PWD = "Wrong password.";

    public static final String NOT_FOUND = "not found.";

    public static final String PASSWORD_NULL = "Password is null";
    public static final String FAIL_LOGIN = "Login failed";
    public static final String NAME_NULL = "Name is null";
    public static final String AREA_NULL = "Area is null";
    public static final String ADDRESS_NULL = "Address is null";
    public static final String MAIL_ADDRESS_NULL = "Mail address is null";
    public static final String CONTACT_NO_NULL = "Contact number is null";
}
